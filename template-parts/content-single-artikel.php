...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	echo '<h3>Status: Digitalisering pågår</h3><p>Den här artikeln håller på att digitaliseras. Snart kommer du kunna ladda ner den i e-boksformat. Välkommen åter!</p>';
	}
